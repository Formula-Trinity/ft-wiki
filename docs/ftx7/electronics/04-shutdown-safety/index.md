...
- [Shutdown Circuit (SDC)](./shutdown-circuit-sdc/index.md)
- [Brake System Plausibility Device (BSPD)](../01-components/safety/BSPD.md)
- [Safety Circuit Monitor (SCM)](../01-components/safety/SCM.md)
- [Brake Over-Travel Switch (BOTS)](./brake-over-travel-switch-bots/index.md)
- [Inertia Switch](../01-components/safety/inertia.md)
- [Low-Voltage Master Switch (LVMS)](../01-components/safety/LVMS.md)
