...
<p align="center">
  <img
    src="images/PetrolDirectInjectionBMW.jpg"
    alt="Fuel injector cutaway"
    width="600"
  >
</p>
...
<p><strong>This document covers general information on fuel injection, the fuel injection process and the type of fuel injection used in the FTX-7 car. For further information related to fuel injection, please use the Navigation list below.</strong></p>

<h2>Navigation</h2>

<ul>
  <li>
    <a href="./fuel_injector/fuel-injector.md">
      How a Fuel Injector Works
    </a>
  </li>

  <li>
    <a href="./injection_timing/injection-timing.md">
      Injection Timing
    </a>
  </li>

  <li>
    <a href="./injection-system_types/injection-system-types.md">
